...
$do = isset($_GET['do']) ? $_GET['do'] : 'Manage';
		...
		<table class="main-table text-center table table-bordered" >
			...
			while($row=mysqli_fetch_assoc($result)){
					...
					echo "<tr>";
						...
						echo "<td>
							<a href='admin.php?do=Edit&id_admin=".$row['id_employee'] . "' class='btn btn-success' ><i class='fa fa-edit'></i> Edit</a>
							<a href='admin.php?do=Delete&id_admin=" . $row['id_employee'] . "' class='btn btn-danger confirm s><i class='fa fa-close'></i> Delete </a>";
					  echo "</td>";
					 echo "</tr>";
				}
			?>
	   ...
	   <i class="fa fa-plus"></i> New ADMIN
		...
		<a href="#">  <span class="adminicon">
		  <i class="fa fa-admin"></i> Admin panel</span> </a>
		  /
		 new admin
...
//end insert page
		...
		<a href="#">  <span class="adminicon">
		 ...
		 Edit Info ADMIN
		  ...
		  <?php echo msg(); ?>
			...
			$id_admin = isset($_GET['id_admin']) && is_numeric($_GET['id_admin']) ? intval($_GET['id_admin']) : 0;
			$query="SELECT * FROM `employee` WHERE id_employee=$id_admin LIMIT 1 "   ;
			$result=mysqli_query($conn,$query);
			...
			<div class="card card-outline-secondary">
				<div class="card-body">
                    ...
                    <div class="form-group row">
						...
						<div class="col-lg-9">
						<select  name="name_college" id="user_time_zone" class="form-control" size="0">
						<option value="0">collegee<option>
						<?php
                                 $query="SELECT `id_College`, `name_College` FROM `college` ";
                                 $result=mysqli_query($conn,$query);
                                 $row=mysqli_fetch_all($result,MYSQLI_ASSOC);
 ...
 <?php
            ...
            echo "<div class='container'>";
                ...
                $sql="DELETE FROM `employee` WHERE id_employee={$id_admin} LIMIT 1";
